    ...
    <section>
      <div className="hero hero-content">
        <div className="card w-full max-w-sm flex-shrink-0 bg-base-100 shadow-2xl  dark:bg-meta-4">
          ...
          <h1 className="mt-2 text-center text-3xl font-bold">Sign Up now!</h1>
          <form onSubmit={handleSubmit} className="card-body">
            <div className="form-control relative">
              <label htmlFor="username" className="absolute right-0 top-3">
                ...
                <FontAwesomeIcon
                  icon={faTimes}
                  className={`${validName || !user ? "hidden" : "text-meta-1"}`}
                />
              </label>
              <input
                type="text"
            ...
            <div className="form-control relative">
              ...
              <p
                id="emailnote"
                className={`${
                  emailFocus && email && !validEmail ? "text-meta-1" : "hidden"
                }`}
              >
            ...
            <div className="form-control relative">
              <label htmlFor="password" className="absolute right-0 top-3">
                ...
                <FontAwesomeIcon
                  icon={faTimes}
                  className={`${validPwd || !pwd ? "hidden" : "text-meta-1"}`}
                />
              </label>
              <input
                type="password"
