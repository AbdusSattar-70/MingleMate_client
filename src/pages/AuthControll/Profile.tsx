            ...
            <div className="relative drop-shadow-2">
              <div className="avatar online">
                <div className=" rounded-full">
                  <img src={auth.avatar || userSix} alt="profile" />
                </div>
              </div>
            </div>
          </div>
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">
              ...
              <span className="text-xl text-meta-5">
                {auth.role === 2 ? "(Admin user)" : "(Regular user)"}
              </span>
            </h3>
            <p className="font-medium">
              {auth?.profession || "Ui/Ux Designer"}
            </p>
            <div className="mx-auto mb-5.5 mt-4.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark">
                <div className="font-semibold text-black dark:text-white">
                  {formattedTime(auth?.updated_at).split(" ")[0]}
                </div>
                <div className="text-xs">Updated at</div>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark">
                <span className="font-semibold text-black dark:text-white">
                  {auth.collections_count}
                </span>
